"""Module for handling file system operations, such as dumping data to JSON files."""
...
class FileSystem:
    """
    A utility class for handling file system operations, such as dumping data to JSON files.
    """
            ...
            if location.exists():
                if location.is_dir(follow_symlinks=False):
                    ...
                    if existing_target == target:
                        logger.info(
                            "Symbolic link %s already exists. Skipping creation.",
                            link_name,
                        )
                        return
                    location.unlink()
